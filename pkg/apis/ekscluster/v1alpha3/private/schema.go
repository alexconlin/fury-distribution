...
type EksclusterKfdV1Alpha3 struct {
	// ApiVersion corresponds to the JSON schema field "apiVersion".
	ApiVersion string `json:"apiVersion" yaml:"apiVersion"`

	// Kindo corresponds to the JSON schema field "kindo".
	Kindo *EksclusterKfdV1Alpha3Kindo `json:"kindo,omitempty" yaml:"kindo,omitempty"`
...
type EksclusterKfdV1Alpha3Kindo string

const EksclusterKfdV1Alpha3KindoEKSCluster EksclusterKfdV1Alpha3Kindo = "EKSCluster"
...
var enumValues_EksclusterKfdV1Alpha3Kindo = []interface{}{
	"EKSCluster",
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *EksclusterKfdV1Alpha3Kindo) UnmarshalJSON(b []byte) error {
	var v string
	if err := json.Unmarshal(b, &v); err != nil {
		return err
	}
	var ok bool
	for _, expected := range enumValues_EksclusterKfdV1Alpha3Kindo {
		if reflect.DeepEqual(v, expected) {
			ok = true
			break
		}
	...
	if !ok {
		return fmt.Errorf("invalid value (expected one of %#v): %#v", enumValues_EksclusterKfdV1Alpha3Kindo, v)
	}
	*j = EksclusterKfdV1Alpha3Kindo(v)
	return nil
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *EksclusterKfdV1Alpha3) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["apiVersion"]; !ok || v == nil {
		return fmt.Errorf("field apiVersion in EksclusterKfdV1Alpha3: required")
	}
	if v, ok := raw["metadata"]; !ok || v == nil {
		return fmt.Errorf("field metadata in EksclusterKfdV1Alpha3: required")
	}
	if v, ok := raw["spec"]; !ok || v == nil {
		return fmt.Errorf("field spec in EksclusterKfdV1Alpha3: required")
	}
	type Plain EksclusterKfdV1Alpha3
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = EksclusterKfdV1Alpha3(plain)
	return nil
}
